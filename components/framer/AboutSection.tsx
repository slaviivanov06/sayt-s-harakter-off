...
const team = [
  ...
  },
  {
    ...
    role: "Дизайн & Визия",
    tag: "DESIGN",
    desc: "Отговаря за цялостния визуален език — от архитектурата на сайта до най-малкия детайл в интерфейса. Убеден, че доброто дизайн продава.",
    photo: "/dimitar.png",
  },
];
      ...
      <div className="max-w-[1180px] mx-auto">
        ...
        <div className="mb-12 md:mb-20 overflow-hidden">
          ...
          <p className="text-[#F0F4FF]/60 mt-4 max-w-xl text-lg leading-relaxed"
            ...
            Не сме агенция. Сме двама — дизайнер и разработчик — които работят директно с теб от старт до край.
          </p>
        </div>
